...
void SemanticAnalyzer::registerFunctions(Program& program) {
    // Builtin Rosie Runtime Functions
    functions_["println_int"] = FunctionSymbol{Type::makeVoid(), {Type::makeInt()}};
    functions_["print_int"] = FunctionSymbol{Type::makeVoid(), {Type::makeInt()}};
    functions_["println_str"] = FunctionSymbol{Type::makeVoid(), {Type::makePointer(Type::makeChar())}};
    functions_["print_str"] = FunctionSymbol{Type::makeVoid(), {Type::makePointer(Type::makeChar())}};
    functions_["clock_ms"] = FunctionSymbol{Type::makeInt(), {}};
    ...
    for (auto& fn : program.functions) {
        ...
        if (functions_.count(fn->name) && fn->name != "println_int" && fn->name != "print_int" &&
            fn->name != "println_str" && fn->name != "print_str" && fn->name != "clock_ms") {
